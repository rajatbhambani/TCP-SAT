...
% Apply page geometry fixes after IEEEtran initialises its layout,
% so these settings are not overridden by the class.
% top=0.75in, bottom>=0.95in: topmargin=-0.25in, textheight=9.3in
% gutter>=0.2in: columnsep=0.3in
\AtBeginDocument{%
